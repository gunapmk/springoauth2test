...
public class SpringRestClient {
    ...
    public static final String REST_SERVICE_URI = "http://localhost:8080/springoauth2test";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8080/springoauth2test/oauth/token";
